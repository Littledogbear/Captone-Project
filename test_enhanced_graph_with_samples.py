"""
Test Enhanced Knowledge Graph with Malware Samples

This script demonstrates the enhanced knowledge graph visualization with
relationship labels, color legend, and interactive features.
"""
...
def main():
    ...
    output_dir = os.path.join(os.path.dirname(__file__), "output", "enhanced_graph_test")
    ...
    html_path = os.path.join(output_dir, f"enhanced_graph_{timestamp}.html")
